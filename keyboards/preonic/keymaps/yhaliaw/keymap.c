/* Copyright  Andrew Liaw
 *
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_preonic_grid(
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_LOCK,
     ...
     * |   `  |   1  |   2  |   3  |   4  |   5  |   6  |   7  |   8  |   9  |   0  |      |
     * |------+------+------+------+------+-------------+------+------+------+------+------|
     * | Caps | Vol- | Vol+ | Next | Play |------| Left | Down |  Up  | Right|------|  \   |
     * |------+------+------+------+------+------|------+------+------+------+------+------|
     * |      | Bri- | Bri+ | Print| Pause|------|------| Home | End  | Pg Up| Pg Dn|      |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |      |      |      |      |      |      |      |      |      |      |      |      |
     * `-----------------------------------------------------------------------------------'
     */
    [_LOWER] = LAYOUT_preonic_grid(
        ...
        KC_CAPS, KC_VOLD, KC_VOLU, KC_MNXT, KC_MPLY, XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, KC_BSLS,
        _______, KC_BRID, KC_BRIU, KC_PSCR, KC_PAUS, XXXXXXX, XXXXXXX, KC_HOME, KC_END,  KC_PGUP, KC_PGDN, _______,
    ...
    [_ADJUST] = LAYOUT_preonic_grid(
        ...
        _______, XXXXXXX, XXXXXXX, AU_ON,   AU_OFF,  CG_SWAP, CG_NORM, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
...
const rgblight_segment_t PROGMEM adjust_layer[] = RGBLIGHT_LAYER_SEGMENTS({0, 9, HSV_BLUE});

const rgblight_segment_t PROGMEM capslock_layer[] = RGBLIGHT_LAYER_SEGMENTS({54, HSV_WHITE});
